...
```text
https://raw.githubusercontent.com/Linorman/Custom_OpenClash_Rules/main/cfg/Custom_Clash_AI.ini
```

Custom_Clash_Mainland_Related.ini

```text
https://raw.githubusercontent.com/Linorman/Custom_OpenClash_Rules/main/cfg/Custom_Clash_Mainland_Related.ini
```
